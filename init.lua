-- Based on Kickstart.nvim project
...
-- show the source of the disgnostic when opening in float window
...
require('lazy').setup({
  ...
  --  Uncomment any of the lines below to enable them (you will need t restart nvim).
  --
